...
def image_add_tree(imgPath, outImgePath):
    # 水印图片
...
def add_hat(imgPath, outputPath):

    num = random.randint(1, 4)
    hat_img_Path = "img_hat/hat_" + str(num) + ".png"
    ...
    if len(dets)>0:  
        ...
        # 添加圣诞树
        print("圣诞树")
        image_add_tree(imgPath, outputPath)
        

# 读取头像图
imgPath = "Image/girl.jpg"
outputPath = "./Image/output.jpg"

add_hat(imgPath, outputPath)
